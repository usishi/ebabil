...
defaultOptions = {
	...
	lang: {
		...
		shortMonths: ['Ock', 'Şub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Ağu', 'Eyl', 'Ekm', 'Kas', 'Ara'],
	...
	global: {
		useUTC: true,
		canvasToolsURL: '/static/javascripts/highstock/other/canvas-tools.js',
		VMLRadialGradientURL: '/static/javascripts/highstock/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
Chart.prototype = {
	...
	destroy: function () {
		...
		each(['title', 'subtitle', 'chartBackground', 'plotBackground', 'plotBGImage', 'plotBorder', 'seriesGroup', 'clipRect',  'tracker', 'scroller', 'rangeSelector', 'legend', 'resetZoomButton', 'tooltip', 'renderer'], function (name) {
			var prop = chart[name];
